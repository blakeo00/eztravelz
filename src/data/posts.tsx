...
export const posts: BlogPost[] = [
    ...
    },
    {
        ...
        title: "Spring Mountain Ranch State Park: The Las Vegas Day Trip Worth Every Degree of Cool Air",
        excerpt: "25 miles from the Strip, Spring Mountain Ranch State Park offers cooler temps, rich history, hiking trails, and summer theatre under the stars. A perfect Las Vegas day trip locals actually take.",
...
function springMountainRanchContent(): ReactNode {
    return (
        <div className="prose prose-lg max-w-none prose-headings:text-white prose-p:text-slate-100 prose-a:text-[#89D4FF] hover:prose-a:text-[#fff0d4] prose-strong:text-white prose-hr:border-slate-600">
            ...
            <div className="my-8 rounded-2xl bg-white/10 border border-white/20 p-8 text-center shadow-lg transition-transform hover:-translate-y-1 duration-300 not-prose">
                ...
                <p className="text-slate-200 mb-6 max-w-2xl mx-auto">
                    ...
                    entirely. Worth a look if you are visiting and want to cover more ground.
                </p>
                <a
