...
export const metadata: Metadata = {
    title: "Paws & Away: What Every Pet Traveler Needs to Know Before They Book That Ticket | EZtravelZ",
    description: "From airline rules and service animal regulations to road trip safety and Amtrak policies — the complete, no-fluff guide to traveling with your pet in 2026.",
    alternates: {
        canonical: "https://eztravelz.com/pet-travel/paws-and-away-pet-traveler-guide",
    },
    openGraph: {
        type: "article",
        url: "https://eztravelz.com/pet-travel/paws-and-away-pet-traveler-guide",
        siteName: "EZtravelZ",
        title: "Paws & Away: What Every Pet Traveler Needs to Know | EZtravelZ",
        description: "The complete, no-fluff guide to traveling with your pet in 2026 — airlines, Amtrak, road trips and more.",
        images: [
            {
                url: "https://eztravelz.com/images/Pet Airport.png",
                width: 1200,
                height: 630,
                alt: "A dog at the airport ready to travel",
            },
        ],
    },
};

export default function PawsAndAwayPage() {
    const post = getPostBySlug("paws-and-away-pet-traveler-guide");
    if (!post) return null;
