        ...
        <div className="min-h-screen font-sans flex flex-col relative bg-slate-950">
            ...
            <div className="relative z-10 flex flex-col flex-grow w-full">
                ...
                <main className="flex-grow pb-20">
                    {/* Hero section */}
                    <section className="relative overflow-hidden bg-sky-700/95 text-white py-20 px-4 text-center border-b-4 border-sky-800">
                        ...
                        <div className="relative z-10">
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 font-serif text-white">
                                Pet Travel
                            </h1>
