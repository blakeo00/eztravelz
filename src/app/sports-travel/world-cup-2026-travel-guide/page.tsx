...
export const metadata: Metadata = {
    title: "The World Is Coming To Your Backyard: A Guide To The 2026 FIFA World Cup | EZtravelZ",
    description: "June 11 to July 19, 2026. Forty-eight teams. One hundred and four matches. Three countries. The complete fan's travel guide to Mexico City, Miami, and New York.",
    alternates: {
        canonical: "https://eztravelz.com/sports-travel/world-cup-2026-travel-guide",
    },
    openGraph: {
        type: "article",
        url: "https://eztravelz.com/sports-travel/world-cup-2026-travel-guide",
        siteName: "EZtravelZ",
        title: "A Guide To The 2026 FIFA World Cup | EZtravelZ",
        description: "The complete fan's travel guide to Mexico City, Miami, and New York for the 2026 FIFA World Cup.",
        images: [{ url: "https://eztravelz.com/images/Metlife2.jpg", width: 1200, height: 630, alt: "MetLife Stadium" }],
    },
};

export default function WorldCup2026Page() {
    const post = getPostBySlug("world-cup-2026-travel-guide");
    if (!post) return null;
