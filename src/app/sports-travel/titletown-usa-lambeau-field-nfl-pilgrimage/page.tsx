...
export const metadata: Metadata = {
    title: "Titletown, USA: Why a Trip to Lambeau Field Is the NFL's Most Sacred Pilgrimage | EZtravelZ",
    description: "Green Bay has 106,000 people, 13 NFL championships, and a stadium that hasn't had an empty seat since 1960. Some pilgrimages are worth the journey. This is one of them.",
    alternates: {
        canonical: "https://eztravelz.com/sports-travel/titletown-usa-lambeau-field-nfl-pilgrimage",
    },
    openGraph: {
        type: "article",
        url: "https://eztravelz.com/sports-travel/titletown-usa-lambeau-field-nfl-pilgrimage",
        siteName: "EZtravelZ",
        title: "Titletown, USA: A Pilgrimage to Lambeau Field | EZtravelZ",
        description: "Why Lambeau Field is the NFL's most sacred pilgrimage — and how to make the trip.",
        images: [{ url: "https://eztravelz.com/images/Lambeau.png", width: 1200, height: 630, alt: "Lambeau Field stadium" }],
    },
};

export default function LambeauFieldPage() {
    const post = getPostBySlug("titletown-usa-lambeau-field-nfl-pilgrimage");
    if (!post) return null;
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                            <div className="lg:w-2/3">
                                ...
                                <div className="mt-10 text-center lg:text-left">
                                    <Link href="/sports-travel" className="inline-flex items-center gap-2 font-semibold transition-colors text-[#37507a] hover:text-[#5271a3]">
