                    ...
                    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                            ...
                            <div className="lg:w-2/3">
                                <div className="backdrop-blur-md rounded-3xl shadow-xl p-8 sm:p-12 bg-[#37507a] text-white border-2 border-slate-700 shadow-[0_0_30px_rgba(44,72,117,0.25)] prose prose-lg max-w-none prose-headings:text-[#fff0d4] prose-p:text-white prose-a:text-[#e9a43a] hover:prose-a:text-[#c47d1a] prose-strong:text-[#fff0d4] prose-figcaption:text-[#fff0d4] prose-hr:border-white/20 prose-li:text-white">
                                    ...
                                    <h2 className="text-2xl font-bold mt-12 mb-6 text-[#fff0d4]">A Working Orchard and an Animal Sanctuary, Side by Side in the Desert</h2>
                                    ...
                                    <h2 className="text-2xl font-bold mt-12 mb-6 text-[#fff0d4]">Floyd Lamb Park, Where the Peacocks Don&apos;t Care Who You Are</h2>
                                    ...
                                    <h2 className="text-2xl font-bold mt-12 mb-6 text-[#fff0d4]">Container Park, Fergusons, and the Arts District — A Neighborhood Worth a Full Day and Night</h2>
                                    ...
                                    <figure className="my-10 bg-slate-800/50 p-4 rounded-2xl shadow-md border-2 border-slate-700">
                                        <Image
                                            src="/images/18a.jpg"
                                        ...
                                        />
                                        <figcaption className="text-center text-sm text-white/80 mt-4 font-medium italic">
                                    ...
                                    <div className="relative my-8 rounded-2xl bg-slate-800/50 border-2 border-slate-700 p-8 text-center shadow-lg transition-transform hover:-translate-y-1 duration-300 not-prose overflow-hidden group text-white">
                                        <div className="relative z-10">
                                            <p className="text-xs text-[#89D4FF] uppercase tracking-widest font-bold mb-2">
                                                While you&apos;re out there
                                            </p>
                                            <h3 className="text-xl font-bold text-[#fff0d4] mb-3 mt-0">
                                            ...
                                            <a
                                                ...
                                                className="inline-block px-8 py-3.5 rounded-full bg-[#89D4FF] text-[#1e3459] font-bold hover:bg-white hover:shadow-xl hover:scale-105 transition-all duration-300 no-underline"
                                            >
                                    ...
                                    <h2 className="text-2xl font-bold mt-12 mb-6 text-[#fff0d4]">The Fremont Street Experience, Where the Night Has No Ceiling</h2>
                                    ...
                                    <h2 className="text-2xl font-bold mt-12 mb-6 text-[#fff0d4]">The Old Las Vegas Mormon Fort, and an Evening Worth Staying For</h2>
                                    ...
                                    <h2 className="text-2xl font-bold mt-12 mb-6 text-[#fff0d4]">The Bellagio Conservatory, the Glass Ceiling Nobody Looks Up At, and the Sky Ceiling Next Door at Caesars</h2>
                                    ...
                                    <div className="bg-slate-800/50 p-6 rounded-xl italic text-[#fff0d4] text-sm border-2 border-slate-700">
                                        <p className="m-0">
