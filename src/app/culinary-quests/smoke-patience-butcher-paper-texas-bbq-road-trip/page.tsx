...
export const metadata: Metadata = {
    title: "Smoke, Patience, and Butcher Paper: A Texas BBQ Road Trip Worth Every Mile | EZtravelZ",
    description: "Three days. Five stops. A few hundred miles of Hill Country. From Franklin's legendary brisket to the century-old pits at Smitty's, this is the road trip that earns every bite.",
    alternates: {
        canonical: "https://eztravelz.com/culinary-quests/smoke-patience-butcher-paper-texas-bbq-road-trip",
    },
    openGraph: {
        type: "article",
        url: "https://eztravelz.com/culinary-quests/smoke-patience-butcher-paper-texas-bbq-road-trip",
        siteName: "EZtravelZ",
        title: "A Texas BBQ Road Trip Worth Every Mile | EZtravelZ",
        description: "Three days, five legendary BBQ stops through Texas Hill Country.",
        images: [{ url: "https://eztravelz.com/images/BBQ.png", width: 1200, height: 630, alt: "Smoked brisket on butcher paper" }],
    },
};

export default function TexasBBQPage() {
    const post = getPostBySlug("smoke-patience-butcher-paper-texas-bbq-road-trip");
    if (!post) return null;
