                ...
                <main className="flex-grow">
                    ...
                    <section className="relative text-white pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
                        ...
                        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <h1
                                className="text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight mb-6 drop-shadow-lg hero-title text-[#fff0d4]"
                            >
                                {post.title}
                            </h1>
                    ...
                    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                            ...
                            <div className="lg:w-2/3">
                                <div
                                    className="backdrop-blur-md rounded-3xl shadow-xl p-8 sm:p-12 bg-[#37507a] text-slate-50 border-2 border-white/10 shadow-[0_0_30px_rgba(55,80,122,0.4)]"
                                >
                                    {post.content()}
                                </div>
                                ...
                                <div className="mt-10 text-center lg:text-left">
                                    <Link
                                        href="/blog"
                                        className="inline-flex items-center gap-2 font-semibold transition-colors text-[#37507a] hover:text-[#2c4875]"
                                    >
                                        <svg
