...
export default async function BlogPostPage({
    ...
    return (
        <div className="min-h-screen flex flex-col relative bg-slate-50">
            ...
            {(post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel' || post.slug === 'titletown-usa-lambeau-field-nfl-pilgrimage') && (
                <div
                    ...
                    style={{
                        backgroundImage: `url('/images/${post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel' ? 'Stanley Hotel.png' : 'Lambeau.png'}')`
                    }}
                ></div>
            )}
                ...
                <main className="flex-grow">
                    ...
                    <section className="relative text-white py-20 sm:py-28 overflow-hidden">
                        ...
                        <Image
                            ...
                            alt={post.alt}
                            fill
                            className={`object-cover object-center ${post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel' ? 'opacity-50' : ''}`}
                            priority
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/50 to-black/30" />

                        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            <span className={`inline-block text-white text-xs font-bold uppercase tracking-wider px-4 py-1.5 rounded-full mb-6 ${post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel' ? 'bg-red-800' : 'bg-brand-500'
                                }`}>
                                {post.category}
                            </span>
                            ...
                            <h1
                                className={`text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-4 leading-tight ${post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel'
                                    ? 'text-red-600 tracking-widest'
                                    : 'tracking-tight'
                                    }`}
                                style={
                                    post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel'
                    ...
                    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
                        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                            ...
                            <div className="lg:w-2/3">
                                <div className={`backdrop-blur-md rounded-3xl shadow-xl p-8 sm:p-12 ${post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel'
                                ...
                                <div className="mt-10 text-center lg:text-left">
                                    <Link
                                        href="/blog"
                                        className={`inline-flex items-center gap-2 font-semibold transition-colors ${post.slug === 'stanley-hotel-where-the-nightmare-became-the-novel'
