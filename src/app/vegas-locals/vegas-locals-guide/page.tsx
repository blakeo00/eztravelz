...
export const metadata: Metadata = {
    title: "Six Haunted Hotspots in Las Vegas Worth Losing Sleep Over | EZtravelZ",
    description: "Las Vegas has been burying its history under neon since 1905. The mob. The fires. The deaths that never made headlines. Six haunted locations the locals know about and the tour buses mostly miss.",
    alternates: {
        canonical: "https://eztravelz.com/vegas-locals/vegas-locals-guide",
    },
    openGraph: {
        type: "article",
        url: "https://eztravelz.com/vegas-locals/vegas-locals-guide",
        siteName: "EZtravelZ",
        title: "Six Haunted Hotspots in Las Vegas Worth Losing Sleep Over | EZtravelZ",
        description: "Six haunted Las Vegas locations the locals know about and the tour buses mostly miss.",
        images: [
            {
                url: "https://eztravelz.com/images/Zak.jpg",
                width: 1200,
                height: 630,
                alt: "Haunted Las Vegas location",
            },
        ],
    },
};

export default function HauntedHotspotsPage() {
    const post = getPostBySlug("vegas-locals-guide");
    if (!post) return null;
