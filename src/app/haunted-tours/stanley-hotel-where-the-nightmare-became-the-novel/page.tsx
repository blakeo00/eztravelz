...
export const metadata: Metadata = {
    title: "Ghost Trails / Reel Roads: The Stanley Hotel — Where the Nightmare Became the Novel | EZtravelZ",
    description: "The white Georgian Revival hotel at 7,800 feet that cured its builder's tuberculosis, inspired Stephen King's most famous nightmare, and has been collecting ghosts ever since.",
    alternates: {
        canonical: "https://eztravelz.com/haunted-tours/stanley-hotel-where-the-nightmare-became-the-novel",
    },
    openGraph: {
        type: "article",
        url: "https://eztravelz.com/haunted-tours/stanley-hotel-where-the-nightmare-became-the-novel",
        siteName: "EZtravelZ",
        title: "The Stanley Hotel — Where the Nightmare Became the Novel | EZtravelZ",
        description: "The hotel that inspired The Shining: history, hauntings, and how to visit the Stanley Hotel in Estes Park, Colorado.",
        images: [
            {
                url: "https://eztravelz.com/images/Stanley Hotel.png",
                width: 1200,
                height: 630,
...
export default function StanleyHotelPage() {
    const post = getPostBySlug("stanley-hotel-where-the-nightmare-became-the-novel");
    if (!post) return null;
