...
const DansLeNoirArticle = () => {
    return (
        <article className="mt-16 bg-[#ffffff] text-[#37507a] rounded-3xl shadow-2xl overflow-hidden border-2 border-[#37507a]/20 backdrop-blur-sm font-sans" style={{ boxShadow: '0 0 30px rgba(55, 80, 122, 0.15)' }}>
          ...
          while maintaining the requested aesthetic. */}
            ...
            <div className="max-w-[780px] mx-auto my-12 px-6">
                ...
                <span className="inline-block bg-[#fff0d4]/50 border border-[#37507a]/20 text-[#37507a] text-xs font-bold tracking-[0.1em] uppercase py-1.5 px-3.5 rounded-full mb-5">
                    City Dining
                </span>

                <h1 className="font-serif text-[clamp(2rem,5vw,3rem)] leading-[1.2] mb-4 text-[#37507a] font-bold">
                    Dining in the Dark: Paris’s Most Unusual Culinary Experience
                </h1>

                <div className="flex flex-wrap items-center gap-4 text-sm text-[#37507a] font-medium border-b border-[#37507a]/10 pb-5 mb-8">
                    <span>Paris, France</span>
                    <span className="opacity-40">|</span>
                    <span>Unusual Dining</span>
                </div>

                <div className="text-[1.0625rem] leading-[1.75] text-[#37507a] font-medium">
                    <p className="mb-6">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-[#37507a]/20 text-[#37507a] font-bold">Welcome to the Black Room</h2>
                    <p className="mb-6">
                    ...
                    <div className="border-2 border-[#37507a]/20 bg-[#fff0d4]/50 text-[#37507a] p-5 my-8 rounded-xl">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-[#37507a]/20 text-[#37507a] font-bold">How Dining in the Dark Changes Taste</h2>
                    <p className="mb-6">
                    ...
                    {/* Inline image: Paris */}
                    <figure className="my-10 rounded-xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.18)] border-2 border-[#37507a]/20">
                        <img
                            ...
                            loading="lazy"
                        />
                        <figcaption className="text-[0.8125rem] text-[#37507a] font-bold text-center bg-[#fff0d4]/50 py-2.5 px-4 font-mono uppercase tracking-wider">
                            Before the lights go out, guests choose a surprise menu in the softly lit lounge at Dans le Noir in Paris.
                        </figcaption>
                    </figure>

                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-[#37507a]/20 text-[#37507a] font-bold">A Social Experiment as Much as a Meal</h2>
                    <p className="mb-6">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-[#37507a]/20 text-[#37507a] font-bold">Behind the Concept</h2>
                    <p className="mb-6">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-[#37507a]/20 text-[#37507a] font-bold">Practical Details: How to Book</h2>
                    <p className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-6">
                        <div className="bg-[#fff0d4]/50 border-2 border-[#37507a]/20 rounded-xl p-5 hover:shadow-[0_6px_20px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 transition-all duration-200">
                            <div className="text-2xl mb-2">📍</div>
                            <h3 className="font-serif text-[1.05rem] mb-1.5 text-[#37507a] font-bold">Where You Are Going</h3>
                            <p className="text-[0.875rem] text-[#37507a] mb-0 font-medium">Dans le Noir is located at 51 Rue Quincampoix in the fourth arrondissement, a lively area filled with galleries, cafés, and late night energy.</p>
                            <span className="inline-block text-[0.7rem] font-bold tracking-[0.08em] uppercase bg-[#fff0d4]/50 text-[#37507a] py-0.5 px-2 rounded-full mt-2.5 border border-[#37507a]/20">Marais Quarter</span>
                        </div>
                        <div className="bg-[#fff0d4]/50 border-2 border-[#37507a]/20 rounded-xl p-5 hover:shadow-[0_6px_20px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 transition-all duration-200">
                            <div className="text-2xl mb-2">🕒</div>
                            <h3 className="font-serif text-[1.05rem] mb-1.5 text-[#37507a] font-bold">What to Expect</h3>
                            <p className="text-[0.875rem] text-[#37507a] mb-0 font-medium">Plan on about two hours inside the dark room, including a multi course surprise menu, guidance from your server, and a reveal of the dishes afterward.</p>
                            <span className="inline-block text-[0.7rem] font-bold tracking-[0.08em] uppercase bg-[#fff0d4]/50 text-[#37507a] py-0.5 px-2 rounded-full mt-2.5 border border-[#37507a]/20">Evening Experience</span>
                        </div>
                        <div className="bg-[#fff0d4]/50 border-2 border-[#37507a]/20 rounded-xl p-5 hover:shadow-[0_6px_20px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 transition-all duration-200">
                            <div className="text-2xl mb-2">👃</div>
                            <h3 className="font-serif text-[1.05rem] mb-1.5 text-[#37507a] font-bold">Who Will Love It</h3>
                            <p className="text-[0.875rem] text-[#37507a] mb-0 font-medium">Curious food travelers, couples seeking a memorable date, and anyone interested in sensory experiments or inclusive experiences guided by blind hosts.</p>
                            <span className="inline-block text-[0.7rem] font-bold tracking-[0.08em] uppercase bg-[#fff0d4]/50 text-[#37507a] py-0.5 px-2 rounded-full mt-2.5 border border-[#37507a]/20">For Curious Foodies</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#fff0d4]/50 border-2 border-[#37507a]/20 rounded-xl p-6 my-8 text-[#37507a] font-medium">
                        <h3 className="font-serif text-[1.1rem] font-bold mb-3 text-[#37507a]">Tips for Your Night in the Dark</h3>
