...
const DansLeNoirArticle = () => {
    return (
        <article className="mt-16 bg-gray-900/90 text-gray-300 rounded-3xl shadow-2xl overflow-hidden border border-blue-700/50 backdrop-blur-sm font-sans" style={{ boxShadow: '0 0 30px rgba(59, 130, 246, 0.15)' }}>
          ...
          while maintaining the requested aesthetic. */}
            ...
            <img
                className="w-full max-h-[480px] object-cover border-b-4 border-gray-900 grayscale-[20%]"
            ...
            <div className="max-w-[780px] mx-auto my-12 px-6">
                ...
                <span className="inline-block bg-blue-600 text-white text-xs font-semibold tracking-[0.1em] uppercase py-1.5 px-3.5 rounded-full mb-5">
                    City Dining
                </span>

                <h1 className="font-serif text-[clamp(2rem,5vw,3rem)] leading-[1.2] mb-4 text-white">
                    Dining in the Dark: Paris’s Most Unusual Culinary Experience
                </h1>

                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400 border-b border-blue-700/30 pb-5 mb-8">
                    <span>Paris, France</span>
                    <span className="opacity-40">|</span>
                    <span>Unusual Dining</span>
                </div>

                <div className="text-[1.0625rem] leading-[1.75] text-gray-300">
                    <p className="mb-6">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-blue-700/30 text-white">Welcome to the Black Room</h2>
                    <p className="mb-6">
                    ...
                    <div className="border-l-4 border-blue-500 bg-gray-800/80 text-white p-5 my-8 rounded-r-xl">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-blue-700/30 text-white">How Dining in the Dark Changes Taste</h2>
                    <p className="mb-6">
                    ...
                    <figure className="my-10 rounded-xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.18)]">
                        <img
                            ...
                            loading="lazy"
                        />
                        <figcaption className="text-[0.8125rem] text-gray-400 text-center bg-gray-800/80 py-2.5 px-4 font-mono uppercase tracking-wider">
                            Before the lights go out, guests choose a surprise menu in the softly lit lounge at Dans le Noir in Paris.
                        </figcaption>
                    </figure>

                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-blue-700/30 text-white">A Social Experiment as Much as a Meal</h2>
                    <p className="mb-6">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-blue-700/30 text-white">Behind the Concept</h2>
                    <p className="mb-6">
                    ...
                    <h2 className="font-serif text-[1.6rem] mt-10 mb-3.5 pb-1.5 border-b-2 border-blue-700/30 text-white">Practical Details: How to Book</h2>
                    <p className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 my-6">
                        <div className="bg-gray-800/80 border border-blue-700/50 rounded-xl p-5 hover:shadow-[0_6px_20px_rgba(59,130,246,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            <div className="text-2xl mb-2">📍</div>
                            <h3 className="font-serif text-[1.05rem] mb-1.5 text-white">Where You Are Going</h3>
                            <p className="text-[0.875rem] text-gray-400 mb-0">Dans le Noir is located at 51 Rue Quincampoix in the fourth arrondissement, a lively area filled with galleries, cafés, and late night energy.</p>
                            <span className="inline-block text-[0.7rem] font-semibold tracking-[0.08em] uppercase bg-blue-600/30 text-blue-200 py-0.5 px-2 rounded-full mt-2.5 border border-blue-500/30">Marais Quarter</span>
                        </div>
                        <div className="bg-gray-800/80 border border-blue-700/50 rounded-xl p-5 hover:shadow-[0_6px_20px_rgba(59,130,246,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            <div className="text-2xl mb-2">🕒</div>
                            <h3 className="font-serif text-[1.05rem] mb-1.5 text-white">What to Expect</h3>
                            <p className="text-[0.875rem] text-gray-400 mb-0">Plan on about two hours inside the dark room, including a multi course surprise menu, guidance from your server, and a reveal of the dishes afterward.</p>
                            <span className="inline-block text-[0.7rem] font-semibold tracking-[0.08em] uppercase bg-blue-600/30 text-blue-200 py-0.5 px-2 rounded-full mt-2.5 border border-blue-500/30">Evening Experience</span>
                        </div>
                        <div className="bg-gray-800/80 border border-blue-700/50 rounded-xl p-5 hover:shadow-[0_6px_20px_rgba(59,130,246,0.15)] hover:-translate-y-0.5 transition-all duration-200">
                            <div className="text-2xl mb-2">👃</div>
                            <h3 className="font-serif text-[1.05rem] mb-1.5 text-white">Who Will Love It</h3>
                            <p className="text-[0.875rem] text-gray-400 mb-0">Curious food travelers, couples seeking a memorable date, and anyone interested in sensory experiments or inclusive experiences guided by blind hosts.</p>
                            <span className="inline-block text-[0.7rem] font-semibold tracking-[0.08em] uppercase bg-blue-600/30 text-blue-200 py-0.5 px-2 rounded-full mt-2.5 border border-blue-500/30">For Curious Foodies</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-blue-900/20 border border-blue-700/30 rounded-xl p-6 my-8 text-gray-300">
                        <h3 className="font-serif text-[1.1rem] mb-3 text-blue-400">Tips for Your Night in the Dark</h3>
