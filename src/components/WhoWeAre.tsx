...
export default function WhoWeAre() {
  return (
    <section className="w-full py-16 px-4" style={{ background: 'transparent' }}>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="w-full lg:w-3/5">
            ...
            <p className="text-white/90 leading-relaxed mb-4" style={{ fontSize: '1rem' }}>
              ...
              <a href="/pet-travel" className="underline hover:no-underline" style={{ color: '#FFD700', fontWeight: '700' }}>Pet-friendly travel</a> takes you to destinations like Ocean Beach in San
              ...
              it&rsquo;s too late.{' '}
              <a href="/sports-travel" className="underline hover:no-underline" style={{ color: '#FFD700', fontWeight: '700' }}>Sports travel</a> explores all things sports, from NFL game day travel guides
              to bucket list international sporting events like the FIFA World Cup and the once in a
              lifetime must see Olympic Games.{' '}
              <a href="/culinary-quests" className="underline hover:no-underline" style={{ color: '#FFD700', fontWeight: '700' }}>Culinary travel</a> follows the food, from authentic food tours and
              farm-to-table dining experiences to regional and international road trips built entirely
              around what&rsquo;s on the plate.{' '}
              <a href="/wine-destinations" className="underline hover:no-underline" style={{ color: '#FFD700', fontWeight: '700' }}>Wine and brewery travel</a> explores hidden gem vineyards, craft beer tours,
              the beautiful regions where they reside and the tasting rooms worth planning a trip
              around.{' '}
              <a href="/cinematic-travel" className="underline hover:no-underline" style={{ color: '#FFD700', fontWeight: '700' }}>Cinematic travel</a> takes movie lovers to the actual filming locations of
              ...
              <a href="/haunted-tours" className="underline hover:no-underline" style={{ color: '#FFD700', fontWeight: '700' }}>haunted tours</a> is the go-to spot where history runs darkest. We cover
            ...
            <a
              ...
              style={{ color: '#FFD700', borderBottom: '2px solid #FFD700', paddingBottom: '2px' }}
            >
