    ...
    return (
        <article className="bg-[#37507a] text-white rounded-3xl shadow-2xl overflow-hidden border-2 border-white/20 p-8 md:p-12 mb-12 backdrop-blur-sm" style={{ boxShadow: '0 0 30px rgba(0, 0, 0, 0.3)' }}>
            ...
            <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-white prose-headings:font-bold prose-a:text-blue-300 hover:prose-a:text-blue-200 text-white">
                ...
                {/* Inline Image */}
                <figure className="my-10 rounded-xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.18)] border-2 border-white/20 not-prose">
                    <div className="relative w-full h-64 md:h-96 border-b-2 border-white/20">
                        <Image
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-8 not-prose">
                    ...
                    <a href="https://www.sallyssandiego.com/" target="_blank" rel="noopener noreferrer" className="block group bg-[#fff0d4]/50 border-2 border-white/20 rounded-xl p-5 hover:shadow-[0_6px_20px_rgba(0,0,0,0.3)] hover:-translate-y-1 transition-all duration-300">
                        ...
                        <span className="inline-block text-[0.7rem] font-bold tracking-wider uppercase bg-[#37507a] border border-white/20 text-white py-1 px-3 rounded-full">Dog Menu</span>
                    </a>
                </div>
            ...
            <div className="mt-12 mb-4 text-center">
                ...
                >
                    <img
                        ...
                        className="w-full h-auto object-cover group-hover:scale-105 transition-transform duration-500 border-2 border-white/20"
                    />
